...
float ComputeTopness(int& index_b1, int& index_b2, double &tWL, double &tTL, double& tTM){
	...
	int max_comb = jet_order.size();
	if(jet_order.size()>5) max_comb = 5;
...
int main (int argc, char *argv[])
{
    ...
    // ####################
     ...
     screwdriver.AddVariable("Pz_ttbar",             "Pz of ttbar system",            "GeV",    40,-2500,2500,     &(myEvent.Pz_ttbar),                   "");
     screwdriver.AddVariable("Pt_ttbar",             "Pt of ttbar system",            "GeV",    40,0,1500,     &(myEvent.Pt_ttbar),                   "");
     screwdriver.AddVariable("E_ttbar",             "E of ttbar system",            "GeV",    80,0,3000,     &(myEvent.E_ttbar),                   "");
     screwdriver.AddVariable("M_ttbar",             "Mass of ttbar system",            "GeV",    80,0,3000,     &(myEvent.M_ttbar),                   "");
     screwdriver.AddVariable("nofISR",             "Number of ISR",            "",    10, 0, 10,     &(myEvent.nofISR),                   "");
     screwdriver.AddVariable("nofJets",             "Number of jets",            "",    10, 0, 10,     &(myEvent.ngoodjets),                   "");
...
//	*/
    ...
    // ##########################
        ...
        screwdriver.AddRegion("baselineSmallDM300",          "Baseline S.R. - Small #DeltaM - MET>300",      &goesInSmallDMSR300);
...
/*
 ...
 vector<string> regions  = { 
  ...
  string exportFile = "rawYieldTables/prediction_top3.tab";
  TableDataMC(&screwdriver,regions,"allChannels").Print(exportFile,4);
  string exportFile2 = "rawYieldTables/predictionSig_top3.tab";
