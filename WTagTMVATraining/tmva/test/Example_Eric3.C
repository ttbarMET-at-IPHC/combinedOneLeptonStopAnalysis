...
void Example_Eric3( TString myMethodList = "" ) 
{
   ...
   //1: Mll window: ttZ - tt discri
   //2: M3  window: ttW - tt discri
   //3: others : ttW ttZ discri
   int box=1; 
   bool all = false;
   ...
   TString outfileName( "TMVA_Eric_BDT.root" );
...
//    factory->AddVariable( "var4",                "Variable 4", "units", 'F' );
   ...
   */
   ...
   // Variables for Mll window :ttZ tt discri
   if(box==1){
  	 /*
	 if(all){
 	 	 factory->AddVariable( "Mll:=Mll",'F' );
  		 factory->AddVariable( "Njets:=Njets",'F' );
  		 factory->AddVariable( "DPhi_ll:=DPhi_ll",'F' );
 		 factory->AddVariable( "MET:=MET",'F' );
		 factory->AddVariable( "HT:=HT",'F' );
		 factory->AddVariable( "Mt2_bl:=Mt2_bl",'F' );
		 factory->AddVariable( "HTSSM:=HTSSM",'F' );
		 factory->AddVariable( "Mt2_w:=Mt2_w",'F' );
		 factory->AddVariable( "HTOSM:=HTOSM",'F' );
		 //factory->AddVariable( "SumBtag_qq:SumBtag_qq",'F' );
		 //factory->AddVariable( "aplanarity:=aplanarity",'F' );
		 factory->AddVariable( "DPt_ll:=DPt_ll",'F' );
  	 }
	   else{ 
	...
	*/
	   //Variables for ttV 
	   ///*
	   factory->AddVariable( "MET:=MET" );
	   factory->AddVariable( "ProbChi2:=ProbChi2" );
	   factory->AddVariable( "HT:=HT" );
	   factory->AddVariable( "Mt:=Mt" );
	   factory->AddVariable( "DR_bb:=DR_bb" );
	   factory->AddVariable( "DR_ll:=DR_ll" );
	   factory->AddVariable( "QDisj1:=QDisj1" );
   	   factory->AddVariable( "QDisj2:=QDisj2" );
   	   //factory->AddVariable( "Njets:=Njets" );
   	   factory->AddVariable( "Pt_ll:=Pt_ll" );
   	  //*/
	   //Variables for ttV 
	   /*
	   factory->AddVariable( "Mqq:=Mqq" );
	   factory->AddVariable( "MET:=MET" );
	   factory->AddVariable( "ProbChi2:=ProbChi2" );
	   factory->AddVariable( "HT:=HT" );
	   factory->AddVariable( "Mt:=Mt" );
...
if(box==2){
if(all){
   //Variables for M3 widow : ttW tt discri
    factory->AddVariable( "HT:=HT" );
    factory->AddVariable( "HTOSM:=HTOSM" );
    factory->AddVariable( "Mt:=Mt" );
    factory->AddVariable( "Mt2_w:=Mt2_w" );
    factory->AddVariable( "Mt2_bl:=Mt2_bl" );
    factory->AddVariable( "Pt_qq:=Pt_qq" );
    //factory->AddVariable( "HTSSM:=HTSSM" );
    factory->AddVariable( "Mt2_b:=Mt2_b" );
    factory->AddVariable( "MET:=MET" );
    factory->AddVariable( "Mqq:=Mqq" );
    factory->AddVariable( "Mll:=Mll" );
    factory->AddVariable( "DPt_ll:=DPt_ll" );
    factory->AddVariable( "Eta_qq:=Eta_qq" );
    //factory->AddVariable( "isotropy:=isotropy",'D' );
    //factory->AddVariable( " SumBtag_qq:= SumBtag_qq" );
   factory->AddVariable( "Njets:=Njets" );
    factory->AddVariable( "DPt_lblb:=DPt_lblb" );
}
else{
    factory->AddVariable( "HT:=HT" );
    factory->AddVariable( "Mt2_w:=Mt2_w" );
...
if(box==3){ 
if(all){
    //Variables for others" ttW ttZ discri
    factory->AddVariable( "MET:=MET" );
    factory->AddVariable( "Njets:=Njets" );
    factory->AddVariable( "Mt:=Mt" );
    factory->AddVariable( "Mt2_w:=Mt2_w" );
    ...
    factory->AddVariable( "Mt2_bl:=Mt2_bl" );
    factory->AddVariable( "Mll:=Mll" );
    factory->AddVariable( "DPhi_ll:=DPhi_ll" );
    factory->AddVariable( "HTOSM:=HTOSM" );
    factory->AddVariable( "DPt_bb:=DPt_bb" );
    factory->AddVariable( "DPt_ll:=DPt_ll" );
    factory->AddVariable( "circularity:=circularity" );
    factory->AddVariable( "DPt_lblb:=DPt_lblb" );
    factory->AddVariable( "Mqq:=Mqq" );
    factory->AddVariable( "HTSSM:=HTSSM" );
    factory->AddVariable( "Mt2_b:=Mt2_b" );
    factory->AddVariable( "Pt_qq:=Pt_qq" );
    factory->AddVariable( "Eta_qq:=Eta_qq" );
    //factory->AddVariable( "isotropy:=isotropy" );
    //factory->AddVariable( "SumBtag_:=SumBtag_" );
}
else{
    factory->AddVariable( "MET:=MET" );
    factory->AddVariable( "Mll:=Mll" );
...
// but will appear in the final "TeaplanaritystTree" produced by TMVA. This TestTree will contain the 
...
//TFile* f1 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof10-04-13_16-00-57/proof_ttZ.root");
TFile* f0 = 0;
TFile* f1 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof29-04-13_18-41-27/proof_ttZ.root");
TFile* f2 = 0;
if(box==1) {
//f0 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof29-04-13_18-41-27/proof_ttZ.root");
//f1 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof29-04-13_18-41-27/proof_tt-dilepton.root");
/*
f0 = TFile::Open("/grid_mnt/opt__sbg__data__safe1/cms/echabert/ttV/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/Prod_AddTbtag_10Mai/proof_ttZ.root");
f1 = TFile::Open("/grid_mnt/opt__sbg__data__safe1/cms/echabert/ttV/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/Prod_AddTbtag_10Mai/proof_tt-dilepton.root");
f2 = TFile::Open("/grid_mnt/opt__sbg__data__safe1/cms/echabert/ttV/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/Prod_AddTbtag_10Mai/proof_DY4jets.root");
*/
f0 = TFile::Open("/grid_mnt/opt__sbg__data__safe1/cms/echabert/GluonTag/setupMTAnalysisProduction/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/Prod_24Juin/proof_ttZ.root");
f1 = TFile::Open("/grid_mnt/opt__sbg__data__safe1/cms/echabert/GluonTag/setupMTAnalysisProduction/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/Prod_24Juin/proof_tt-dilepton.root");
f2 = TFile::Open("/grid_mnt/opt__sbg__data__safe1/cms/echabert/GluonTag/setupMTAnalysisProduction/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/Prod_24Juin/proof_DY4jets.root");
f3 = TFile::Open("/grid_mnt/opt__sbg__data__safe1/cms/echabert/GluonTag/setupMTAnalysisProduction/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/Prod_24Juin/proof_ttW.root");
}
if(box==2){
f0 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof29-04-13_18-41-27/proof_ttW.root");
f1 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof29-04-13_18-41-27/proof_tt-dilepton.root");
}
if(box==3){
f0 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof29-04-13_18-41-27/proof_ttW.root");
f1 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof29-04-13_18-41-27/proof_ttZ.root");
}
...
//factory->AddSignalTree    ( signal2,     signalWeight2     );
...
// mll window
if(box==1){ 
mycuts = "Channel != 2 && NBjets >=2 && Mll>=80 && Mll<=100 && Njets >=4";
mycutb = "Channel != 2 && NBjets >=2 && Mll>=80 && Mll<=100 && Njets >=4";
//mycuts = "NBjetsL >=2 && (Mll<60 || Mll>120) && Njets >=4";
//mycutb = "NBjetsL >=2 && (Mll<80 || Mll>120) && Njets >=4";
}
//M3 window
if(box==2){
mycuts = "(Mll<80 || Mll>100) && (M3>=150 && M3<=200)";
mycutb = "(Mll<80 || Mll>100) && (M3>=150 && M3<=200)";
}
//others
if(box==3){
mycuts = "(Mll<80 || Mll>100) && (M3<150 || M3>200)";
