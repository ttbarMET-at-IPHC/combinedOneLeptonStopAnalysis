...
void Example_Eric_newVar( TString myMethodList = "" ) 
{
...
//    factory->AddVariable( "var4",                "Variable 4", "units", 'F' );
   ...
   //those 2 variables seems to be not sensitive !
   //factory->AddVariable( "Charge_qq := Charge_qq", 'F' );
   //factory->AddVariable( "DPhi_ll := DPhi_ll", 'F' );

   // new variables
   //factory->AddVariable( "asym:=Pt_qq/HT",'F'); //new one
   ...
   //those variables seems to be not sensitive
   //factory->AddVariable( " HTOSM:= HTOSM", 'F' );
   //factory->AddVariable( " HTSSM:= HTSSM", 'F' );
   //factory->AddVariable( " Mt2_b:= Mt2_b", 'F' );
   //factory->AddVariable( " Mt2_bl:= Mt2_bl", 'F' );
   //factory->AddVariable( " DeltaPhi:=DeltaPhi ", 'F' );
   //factory->AddVariable( " isotropy:=isotropy ", 'F' );
   //factory->AddVariable( " circularity:=circularity ", 'F' );
   
   //Problem while filing this variable
   //factory->AddVariable( " Chi2:=Chi2 ", 'F' );
   ...
   if (ReadDataFromAsciiIFormat) {
    ...
    TFile* f0 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof12-04-13_10-39-01/proof_ttW.root");
    TFile* f1 = TFile::Open("/opt/sbg/data/data1/cms/echabert/ttbarMET/ProdAlexMars13/CMSSW_5_3_2_patch4/src/NTuple/NTupleAnalysis/macros/TTbarMET/backup_outputProof12-04-13_10-39-01/proof_tt-dilepton.root");
