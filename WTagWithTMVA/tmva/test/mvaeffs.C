...
void mvaeffs( TString fin = "TMVA.root", 
              Bool_t useTMVAStyle = kTRUE, TString formula="S/sqrt(S+B)", Float_t ns = 1000., Float_t nb = 1000. )
              //Bool_t useTMVAStyle = kTRUE, TString formula="sqrt(S+B+0.1*0.1*B*B)/(S)", Float_t ns = 25.3, Float_t nb = 900. )
              //Bool_t useTMVAStyle = kTRUE, TString formula="S/sqrt(S+B)", Float_t ns = 25.3, Float_t nb = 900. )
{
