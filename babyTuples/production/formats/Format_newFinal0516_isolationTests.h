...
typedef struct
{
    ...
    float          leadingLeptonIsolation;      // Absolution isolation of the leading selected lepton
    ...
    float          secondLeptonIsolation;       // Absolution isolation of the second selected lepton
...
void ProofJob::InitializeBranches(TTree* theTree_, babyEvent* myEvent_)
{
    ...
    theTree_->Branch("leadingLeptonIsolation",                       &(myEvent_->leadingLeptonIsolation));
    ...
    theTree_->Branch("secondLeptonIsolation",                        &(myEvent_->secondLeptonIsolation));
...
Bool_t ProofJob::Process(Long64_t entry)
{
    ...
    myEvent.leadingLeptonIsolation      = sel.GetTheLeadingLeptonIsolation();
    ...
    myEvent.secondLeptonIsolation       = sel.GetTheSecondLeptonIsolation();
