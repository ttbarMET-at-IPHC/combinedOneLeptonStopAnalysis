...
bool Selector_lowMass()      { return Selector_cutAndCount(-1,   6, 120, 200,100, 0.8, false); }
bool Selector_mediumDeltaM() { return Selector_cutAndCount(-1,   7, 150, 200,150, 0.8, false); }
bool Selector_highDeltaM()   { return Selector_cutAndCount(-1,  10, 160, 200,180, 0.8, false); }
*/
                                                             
                                                        // MET METsig MT MT2W BPt dPhi ISRjet
bool Selector_offShell()     { return Selector_cutAndCount(-1,   9, 120, -1,  -1, 0.2, true ); }
bool Selector_lowMass()      { return Selector_cutAndCount(-1,   6, 135, 180, -1, 0.8, false); }
bool Selector_mediumDeltaM() { return Selector_cutAndCount(-1,   7, 140, 190,100, 0.8, false); }
bool Selector_highDeltaM()   { return Selector_cutAndCount(300, -1, 120, 200,100, 0.8, false); }
...
int main (int argc, char *argv[])
{
  ...
  // ####################
     ...
     string signalCategory = "T2bw-050";
  ...
  // ##########################
     ...
     screwdriver.AddRegion("lowMass",       "Cut-and-count;Low masses",     &Selector_lowMass);
  ...
  float SF_1ltop_and_Wjets = 1.5;
  float SF_allOthers       = 1.1;
