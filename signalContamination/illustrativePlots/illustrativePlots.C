...
int main (int argc, char *argv[])
{
  ...
  // ####################
    ...
    //         s.AddDataset("rare",   "rare", 0, 0);
     ...
     s.AddProcessClass("T2tt_1",   "T2tt (250/100)",                  "signal",     kSpring-1);
             s.AddDataset("T2tt_250_100",   "T2tt_1", 0, 0);

     s.AddProcessClass("T2tt_2",   "T2tt (650/50)",                   "signal",     COLORPLOT_BLUE);
             s.AddDataset("T2tt_650_50",   "T2tt_2", 0, 0);
